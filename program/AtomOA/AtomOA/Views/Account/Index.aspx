                                    ...
                                    <div class="body">
                                        <div class="control-group">
                                            <label class="control-label">
                                                电话</label>
                                            <div class="controls">
                                                <input ID="telephone_edit" runat="server" CssClass="input-xlarge"
                                        ...
                                        <div class="control-group">
                                            <label class="control-label">
                                                邮件</label>
                                            <div class="controls">
                                                <input ID="email_edit" runat="server" CssClass="input-xlarge" 
                                        ...
                                        <div class="control-group">
                                            <label class="control-label">
                                                QQ </label>
                                            <div class="controls">
                                                <input ID="QQ_edit" runat="server" CssClass="input-xlarge"
                                    ...
                                    <div class="body">
                                        <div class="control-group">
                                            <label class="control-label">
                                                旧密码</label>
                                            <div class="controls">
                                                <input ID="oldPassword_edit" TextMode="Password" runat="server" CssClass="input-xlarge"
                                                    placeholder="请输入旧密码"/>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label">
                                                新密码</label>
                                            <div class="controls">
                                                <input ID="newPassword_edit" TextMode="Password" runat="server" CssClass="input-xlarge"
                                                    placeholder="请输入新密码"/>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <label class="control-label">
                                                再次输入新密码</label>
                                            <div class="controls">
                                                <input ID="newPasswordAgain_edit" TextMode="Password" runat="server" CssClass="input-xlarge"
